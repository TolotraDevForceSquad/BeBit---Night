      ...
      <Switch>
        ...
        {user ? (
          <>
            ...
            {/* Routes POS : Protégées par session POS spécifique */}
            {checkPOSSession() ? (
              <>
                <Route path="/club/pos">
                  <POSManagementPage />
              ...
              // Redirection vers login POS pour toutes les routes POS si pas de session
              <Route path="/club/pos/:rest*">
                {() => {
                  // Redirige immédiatement vers le login POS
                  useEffect(() => {
            ...
            {/* Route de login POS : Toujours accessible (même sans session POS) */}
