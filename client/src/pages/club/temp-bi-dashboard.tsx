                ...
                <CardContent>
                  <div className="h-[250px] flex items-center justify-center">
                    ...
                    <div className="relative w-[180px] h-[180px] flex items-center justify-center">
                      <div className="absolute inset-0 border-8 border-[#818cf8] rounded-full clip-1"></div>
                      <div className="absolute inset-0 border-8 border-[#6366f1] rounded-full clip-2" style={{clipPath: 'polygon(50% 0, 100% 0, 100% 100%, 50% 100%)'}}></div>
                      <div className="absolute inset-0 border-8 border-[#4f46e5] rounded-full clip-3" style={{clipPath: 'polygon(50% 0, 100% 0, 100% 50%, 50% 50%)'}}></div>
                      <div className="absolute inset-0 border-8 border-[#c7d2fe] rounded-full clip-4" style={{clipPath: 'polygon(50% 0, 75% 0, 75% 25%, 50% 25%)'}}></div>
                ...
                <CardContent>
                  <div className="p-8 text-center">
                    ...
                    <p className="text-sm text-muted-foreground max-w-md mx-auto">
                      Cette fonctionnalité sera bientôt disponible avec des analyses détaillées, des tendances historiques et des prévisions de revenus.
                    </p>
                  </div>
                </CardContent>
              </Card>
