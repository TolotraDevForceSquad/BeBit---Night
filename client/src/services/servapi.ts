...
// D:\Projet\BeBit\bebit - new\client\src\services\servapi.ts
import {
  // Types
...
} from '@shared/schema'; // Adjust import path as needed (e.g., '../shared/schema')
import { z } from 'zod';
...
// Assume GET /event-artists for list, etc., if routes have it
